...
###### Firewall
  ...
  Configurações de firewall:
   - Bloqueado tráfego IPV4 e IPV6 de pacotes com IPs inválidos na internet para saída pela porta Eth2.
   - Bloqueado o tráfego TCP e UDP vindos da rede dos clientes diretamente para a rede dos servidores.
